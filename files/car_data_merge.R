...
print("Getting 2018-08 data from repository")
download.file("https://github.com/MEF-BDA503/pj18-orkunberkyuzbasioglu/blob/master/odd_car_sales_data_aug_18.rds?raw=true",destfile=tmprds)
main_data <- bind_rows(main_data,readRDS(tmprds))
